...
import UE, { baidu } from '../editor'
import Editor from '../core/Editor'
import { isFunction } from '../utils/validate'
import Toolbar from '../ui/toolbar'
import Popup from '../ui/popup'
import ShortCutMenu from '../ui/shortcutmenu'
import PastePicker from '../ui/pastepicker'
...
class EditorUI extends UIBase {
  ...
  initEditorUI() {
    ...
    editor.addListener("mousedown", function(t, evt) {
      ...
      Popup.postHide(evt, el);
      ShortCutMenu.postHide(evt);
    });
    ...
    editor.addListener("afterpaste", function() {
      ...
      if (PastePicker) {
        pastePop = new Popup({
          content: new PastePicker({ editor: editor }),
          editor: editor,
    ...
    var popup = new Popup({
      ...
      queryAutoHide: function(el) {
        ...
        return Popup.prototype.queryAutoHide.call(this, el);
      }
    });
    popup.render();
...
UE.getEditor = function(id, opt) {
  ...
  if (!editor) {
    editor = instances[id] = createEditor(opt);
    editor.render(id);
  }
  return editor;
};
