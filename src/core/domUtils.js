 ...
 * @module UE.dom.domUtils
 */
export function getDomNode(node, start, ltr, startFromChild, fn, guard) {
...
/**
     ...
     * ```
     */
export function getPosition(nodeA, nodeB) {
  // 如果两个节点是同一个节点
  if (nodeA === nodeB) {
...
/**
   ...
   * ```
   */
export function remove(node, keepChildren) {
...
/**
   ...
   */
export function getNextDomNode(node, startFromChild, filterFn, guard) {
  return getDomNode(
    node,
    "firstChild",
    "nextSibling",
...
export function getPreDomNode(node, startFromChild, filterFn, guard) {
  return getDomNode(
    node,
    "lastChild",
    "previousSibling",
...
/**
   ...
   * @see UE.dom.domUtils.clearEmptySibling(Node)
   */
export function clearEmptySibling(node, ignoreNext, ignorePre) {
...
/**
   ...
   * ```
   */
export function split(node, offset) {
...
/**
   ...
   * ```
   */
export function isSameElement(nodeA, nodeB) {
...
/**
   ...
   * ```
   */
export function isSameStyle(nodeA, nodeB) {
...
/**
   ...
   * ```
   */
export function isBlockElm(node) {
  return (
    node.nodeType == 1 &&
...
/**
   ...
   * ```
   */
export function breakParent(node, parent) {
  var tmpNode,
    parentClone = node,
    clone = node,
    leftNodes,
...
/**
   ...
   * ```
   */
export function isEmptyInlineElement(node) {
...
/**
   ...
   * ```
   */
export function trimWhiteTextNode(node) {
  function remove(dir) {
    var child;
    while (
      (child = node[dir]) &&
...
/**
   ...
   * ```
   */
export function mergeToParent(node) {
  var parent = node.parentNode;
...
/**
   ...
   * ```
   */
export function mergeSibling(node, ignorePre, ignoreNext) {
...
/**
   ...
   * ```
   */
export function getComputedStyle(element, styleName) {
  //一下的属性单独处理
...
/**
   ...
   * ```
   */
export function addClass(elm, classNames) {
  if (!elm) return;
...
/**
   ...
   */
export function removeDirtyAttr(node) {
  for (
...
/**
   ...
   * ```
   */
export function getChildCount(node, fn) {
  var count = 0,
...
/**
   ...
   */
export function scrollToView(node, win, offsetTop) {
...
/**
   ...
   */
export function isFillChar(node, isInStart) {
...
/**
   ...
   * ```
   */
export function moveChild(src, tag, dir) {
...
/**
   ...
   * ```
   */
export function hasNoAttributes(node) {
  return browser.ie
...
/**
   ...
   */
export function isCustomeNode(node) {
...
/**
   ...
   * ```
   */
export function isTagNode(node, tagNames) {
  return (
    node.nodeType == 1 &&
...
/**
   ...
   */
export function isInNodeEndBoundary(rng, node) {
