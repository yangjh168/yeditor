...
const defaultOptions = function(editor) {
...
/**
  ...
  /**
     ...
     * @see UE.Config
     */
class Editor extends EditorPreferences {
  uid = uid++;
  commands = {};
  options = {};
  shortcutkeys = {};
  ...
  constructor (options) {
    ...
    if (!isEmptyObject(UE.I18N)) {
      //修改默认的语言类型
      this.options.lang = checkCurLang(UE.I18N);
      UE.plugin.load(this);
      langReadied(this);
    } else {
      loadFile(
    ...
    UE.instants["ueditorInstant" + this.uid] = this;
  }
